        ...
        <div class="fixed centered login-model">
            <section class="flex justify-center">
                <form class="sign-in-form flex column">
                    ...
                    <div>
                        <button class="flex social-signing-button facebook-signing-button">
                            <span>
                        ...
                        <button class="flex social-signing-button">
                            <span><svg width="18" height="19" viewBox="0 0 18 19" xmlns="http://www.w3.org/2000/svg">
                                    <path
