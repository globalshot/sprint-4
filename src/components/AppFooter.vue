                ...
                <div class="left-footer flex">
                    <RouterLink to="/">
                        <span class="fiverr-logo-footer">
                            ...
                            <svg width="77" height="23" class="svg-logo" version="1.1" id="Layer_1" x="0px" y="0px" viewBox="-3 298.4 603.5 196.6"
      			...
      			c0,0-9.3,1.9-10.5,10.2s-0.6,71-0.6,71H478v-81.1h-26c0,0-9.9,4.6-9.9,10.2C442.1,576.1,441.1,641.3,441.1,641.3L441.1,641.3z" />
                                    ...
                                    <ellipse inkscape:label="dot" class="dot-copy" cx="570.7" cy="621.6" rx="23.1" ry="24.8">
                                    </ellipse>
                                </g>
                    ...
                    <p class="text-body flex">
                        <span class="copyright text-trunc">© <!-- -->Fixerr International Ltd. 2023
                        </span>
                    </p>
                </div>
